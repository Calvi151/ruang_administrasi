...
<body class="font-body-md text-body-md text-on-surface antialiased flex h-screen overflow-hidden selection:bg-brand-amber/30">
    ...
    <nav class="hidden md:flex flex-col bg-brand-navy fixed left-0 top-0 h-screen w-[280px] py-stack-lg z-20 border-r border-white/5 rounded-r-[24px] shadow-xl shadow-black/20 overflow-hidden">
