...
<div class="bg-surface dark:bg-ds-surface rounded-xl shadow-sm border border-outline-variant/50 dark:border-ds-border/50 overflow-hidden">
    <!-- Employee Header -->
    <div class="px-6 py-4 border-b border-outline-variant/30 dark:border-ds-border/30 bg-surface-container-lowest dark:bg-ds-surface flex items-center gap-4">
        @if($employee->photo)
        ...
        @endif
        <div>
            <h3 class="font-h3 text-h3 text-on-surface dark:text-ds-text-primary">{{ $employee->name }}</h3>
    ...
    <form action="{{ route('employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-5">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" id="name" class="block w-full rounded-lg border-outline-variant dark:border-ds-border bg-surface-container-lowest dark:bg-ds-surface text-on-surface dark:text-ds-text-primary shadow-sm focus:border-primary focus:ring focus:ring-primary/20 py-2.5 pl-10 pr-3 font-body-sm text-body-sm" value="{{ old('name', $employee->name) }}" required>
                    </div>
                </div>
                <div>
                    <label for="email" class="block font-label-md text-label-md text-on-surface dark:text-ds-text-primary mb-1">Email <span class="text-error">*</span></label>
                    <div class="relative">
                        ...
                        <input type="email" name="email" id="email" class="block w-full rounded-lg border-outline-variant dark:border-ds-border bg-surface-container-lowest dark:bg-ds-surface text-on-surface dark:text-ds-text-primary shadow-sm focus:border-primary focus:ring focus:ring-primary/20 py-2.5 pl-10 pr-3 font-body-sm text-body-sm" value="{{ old('email', $employee->email) }}" required>
                    </div>
                </div>
                <div>
                    <label for="password" class="block font-label-md text-label-md text-on-surface dark:text-ds-text-primary mb-1">Password Baru <span class="font-body-sm text-body-sm text-on-surface-variant">(kosongkan jika tidak diubah)</span></label>
                    <div class="relative">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="nip" id="nip" class="block w-full rounded-lg border-outline-variant dark:border-ds-border bg-surface-container-lowest dark:bg-ds-surface text-on-surface dark:text-ds-text-primary shadow-sm focus:border-primary focus:ring focus:ring-primary/20 py-2.5 pl-10 pr-3 font-body-sm text-body-sm" value="{{ old('nip', $employee->nip) }}" required>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-5">
                <div>
                    <label for="role" class="block font-label-md text-label-md text-on-surface dark:text-ds-text-primary mb-1">Hak Akses <span class="text-error">*</span></label>
                    <div class="relative">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="number" id="number" class="block w-full rounded-lg border-outline-variant dark:border-ds-border bg-surface-container-lowest dark:bg-ds-surface text-on-surface dark:text-ds-text-primary shadow-sm focus:border-primary focus:ring focus:ring-primary/20 py-2.5 pl-10 pr-3 font-body-sm text-body-sm" value="{{ old('number', $employee->number) }}">
                    </div>
                </div>
                <div>
                    <label class="block font-label-md text-label-md text-on-surface dark:text-ds-text-primary mb-1">Ganti Foto Profil</label>
