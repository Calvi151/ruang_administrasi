...
<div class="bg-surface dark:bg-ds-surface rounded-xl shadow-sm border border-outline-variant/50 dark:border-ds-border/50 overflow-hidden">
    <div class="px-6 py-4 border-b border-outline-variant/30 dark:border-ds-border/30 bg-surface-container-lowest dark:bg-ds-surface">
        <h3 class="font-h3 text-h3 text-on-surface dark:text-ds-text-primary">Edit Jenis Surat</h3>
        <p class="font-body-sm text-body-sm text-on-surface-variant dark:text-ds-text-secondary mt-1">Perbarui data referensi jenis surat beserta templatenya</p>
    </div>
        ...
        <div class="p-6 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="type_name" id="type_name" class="block w-full rounded-lg border-outline-variant dark:border-ds-border bg-surface-container-lowest dark:bg-ds-surface text-on-surface dark:text-ds-text-primary shadow-sm focus:border-primary focus:ring focus:ring-primary/20 py-2.5 px-3 font-body-sm text-body-sm" value="{{ old('type_name', $letterType->type_name) }}" required>
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="template" id="template" rows="15" class="block w-full rounded-lg border-outline-variant dark:border-ds-border bg-surface-container-lowest dark:bg-ds-surface text-on-surface dark:text-ds-text-primary shadow-sm focus:border-primary focus:ring focus:ring-primary/20 py-2.5 px-3 font-body-sm text-body-sm resize-y" placeholder="Ketik template instruksi surat di sini...">{{ old('template', $letterType->template) }}</textarea>
