...
<div class="px-6 py-8 mx-auto w-full animate-fade-in">
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="font-display-lg text-[28px] font-bold text-on-surface dark:text-[#E8E6E0] leading-tight">Edit Jabatan</h1>
            <p class="text-sm text-on-surface-variant dark:text-[#8B93A8]">Perbarui informasi untuk jabatan ini.</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-[#141C33] rounded-2xl border border-outline-variant/40 dark:border-[#2A3654] shadow-sm p-6 md:p-8">
        <form action="{{ route('positions.update', $position->id) }}" method="POST">
            ...
            <div class="mt-8 pt-6 border-t border-outline-variant/30 dark:border-[#2A3654] flex justify-end gap-3">
                ...
                <button type="submit" class="px-6 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-600 text-white font-bold shadow-lg shadow-amber-500/30 transition-all active:scale-95 flex items-center gap-2">
