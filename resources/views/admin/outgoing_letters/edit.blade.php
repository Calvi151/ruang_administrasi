            ...
            <div class="flex flex-col gap-4">
                    ...
                    <div class="relative">
                        ...
                        <select name="letter_type_id" id="letter_type_id" class="w-full bg-slate-50 border-0 rounded-xl py-3 pl-10 pr-4 text-sm text-heading-slate focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all shadow-sm font-body-md text-body-md appearance-none" required>
                            @foreach($letterTypes as $type)
                                <option value="{{ $type->id }}" {{ old('letter_type_id', $outgoingLetter->letter_type_id) == $type->id ? 'selected' : '' }}>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="date" name="date_sent" id="date_sent" class="w-full bg-slate-50 border-0 rounded-xl py-3 pl-10 pr-4 text-sm text-heading-slate focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all shadow-sm font-body-md text-body-md" value="{{ old('date_sent', $outgoingLetter->date_sent) }}" required>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="mb-2 p-4 bg-primary-fixed/30 rounded-3xl flex items-center justify-between border border-primary-fixed-dim/50">
                        ...
                        <a href="{{ asset('storage/' . $outgoingLetter->file_path) }}" target="_blank" class="text-xs bg-primary text-on-primary px-2 py-1 rounded-full hover:bg-primary-container transition-colors">Lihat File</a>
                    </div>
                    @endif
