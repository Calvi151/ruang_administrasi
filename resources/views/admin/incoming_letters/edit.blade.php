...
<div class="bg-surface-container dark:bg-ds-surface rounded-xl shadow-sm border border-outline-variant/50 dark:border-ds-border/50 overflow-hidden">
    <div class="px-6 py-4 border-b border-outline-variant/30 dark:border-ds-border/30 bg-surface-container-lowest dark:bg-ds-surface">
        <h3 class="font-h3 text-h3 text-on-surface dark:text-ds-text-primary">Edit Surat Masuk</h3>
        <p class="font-body-sm text-body-sm text-on-surface-variant dark:text-ds-text-secondary mt-1">Perbarui detail data surat masuk</p>
    </div>
    ...
    <form action="{{ route('incoming-letters.update', $incomingLetter->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="p-6 space-y-6">
            ...
            <div>
                <label class="block font-label-md text-label-md text-on-surface dark:text-ds-text-primary mb-2">Ganti Lampiran File (PDF)</label>
                ...
                <div class="mb-3 p-3 bg-primary-fixed/30 rounded-lg flex items-center justify-between border border-primary-fixed-dim/50">
                    ...
                    <a href="{{ asset('storage/' . $incomingLetter->file_path) }}" target="_blank"
                        class="text-xs bg-primary dark:bg-ds-bg text-on-primary dark:text-ds-text-primary px-3 py-1.5 rounded-lg hover:opacity-90 transition-colors">Lihat File</a>
                </div>
                @endif
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-5">
                    <div>
                        <label for="letter_number" class="block font-label-md text-label-md text-on-surface dark:text-ds-text-primary mb-1">Nomor Surat <span class="text-error">*</span></label>
                        <div class="relative">
                    ...
                    <div>
                        <label for="sender" class="block font-label-md text-label-md text-on-surface dark:text-ds-text-primary mb-1">Pengirim <span class="text-error">*</span></label>
                        <div class="relative">
                ...
                <div class="space-y-5">
                    <div>
                        <label for="date_received" class="block font-label-md text-label-md text-on-surface dark:text-ds-text-primary mb-1">Tanggal Diterima <span class="text-error">*</span></label>
                        <div class="relative">
                    ...
                    <div>
                        <label for="subject" class="block font-label-md text-label-md text-on-surface dark:text-ds-text-primary mb-1">Perihal / Ringkasan <span class="text-error">*</span></label>
                        <div class="relative">
