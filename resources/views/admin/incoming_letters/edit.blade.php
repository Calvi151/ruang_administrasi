...
@section('page-subtitle', 'Perbarui detail data surat masuk')
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="letter_number" id="letter_number" class="w-full bg-slate-50 border-0 rounded-xl py-3 pl-10 pr-4 text-sm text-heading-slate focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all shadow-sm font-body-md text-body-md" value="{{ old('letter_number', $incomingLetter->letter_number) }}" required>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="sender" id="sender" class="w-full bg-slate-50 border-0 rounded-xl py-3 pl-10 pr-4 text-sm text-heading-slate focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all shadow-sm font-body-md text-body-md" value="{{ old('sender', $incomingLetter->sender) }}" required>
                    </div>
                </div>
